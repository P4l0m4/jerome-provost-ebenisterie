...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead$1({
      title: "Caves \xE0 vin sur mesure | J\xE9r\xF4me Provost Eb\xE9nisterie",
      meta: [
        {
          name: "description",
          content: "Agencement de cave a vin sur mesure, cave a vin en bois, cave a vin haut de gamme."
        }
      ]
    });
    const breadcrumbs = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FurnitureShowcase, {
        story: unref(story),
        "parent-slug": "/cave-a-vin-sur-mesure"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/cave-a-vin-sur-mesure/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DkSoFK7u.mjs.map

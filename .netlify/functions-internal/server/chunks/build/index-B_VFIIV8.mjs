...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead$1({
      title: "Salons et salles \xE0 manger sur mesure | J\xE9r\xF4me Provost Eb\xE9nisterie",
      meta: [
        {
          name: "description",
          content: "Agencement de salons et salles \xE0 manger sur mesure, salons et salles \xE0 manger en bois, salons et salles \xE0 manger haut de gamme."
        }
      ]
    });
    const breadcrumbs = [
      ...
      {
        name: "Salons et salles \xE0 manger",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/salons-et-salles-a-manger-sur-mesure/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-B_VFIIV8.mjs.map

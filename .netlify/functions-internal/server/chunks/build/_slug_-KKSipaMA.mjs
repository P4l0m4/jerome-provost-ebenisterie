...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="furniture-page" data-v-be9a8ec7><div class="furniture-page__wrapper" data-v-be9a8ec7><div class="furniture-page__wrapper__txt" data-v-be9a8ec7><h1 class="furniture-page__wrapper__txt__title" data-v-be9a8ec7>${ssrInterpolate(unref(furniture).title)}</h1><h2 class="furniture-page__wrapper__txt__subtitle" data-v-be9a8ec7>${ssrInterpolate(unref(furniture).subtitle)}</h2><div class="furniture-page__wrapper__txt__richtext" data-v-be9a8ec7>${(_a = ("renderRichText" in _ctx ? _ctx.renderRichText : unref(Ce))(unref(furniture).description)) != null ? _a : ""}</div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/autres-meubles-sur-mesure/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-be9a8ec7"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-KKSipaMA.mjs.map

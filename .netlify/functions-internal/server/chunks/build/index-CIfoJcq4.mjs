...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead$1({
      title: "Meubles d'entr\xE9e sur mesure | J\xE9r\xF4me Provost Eb\xE9nisterie",
      meta: [
        {
          name: "description",
          content: "Cr\xE9ation de meubles d'entr\xE9e sur mesure \xE0 Chamb\xE9ry en Savoie. Cr\xE9ation de meubles d'entr\xE9e haut de gamme sur mesure."
        }
      ]
    });
    const breadcrumbs = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FurnitureShowcase, {
        story: unref(story),
        "parent-slug": "/meubles-entree-sur-mesure"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/meubles-entree-sur-mesure/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-CIfoJcq4.mjs.map

...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead$1({
      title: "Tables et tables basses sur mesure | J\xE9r\xF4me Provost Eb\xE9nisterie",
      meta: [
        {
          name: "description",
          content: "Cr\xE9ation de tables sur mesure et de tables basses sur mesure \xE0 Chamb\xE9ry en Savoie. Cr\xE9ation de tables haut de gamme sur mesure."
        }
      ]
    });
    const breadcrumbs = [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tables-et-tables-basses-sur-mesure/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BMXZ7t4z.mjs.map

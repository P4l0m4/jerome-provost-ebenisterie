...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead$1({
      title: "Amenagement bureau et magasins sur mesure | J\xE9r\xF4me Provost Eb\xE9nisterie",
      meta: [
        {
          name: "description",
          content: "Amenagement bureau, magasin et magasins sur mesure \xE0 Chamb\xE9ry en Savoie. D\xE9couvrez tous nos bureaux, magasins et comptoirs sur mesure."
        }
      ]
    });
    const breadcrumbs = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FurnitureShowcase, {
        story: unref(story),
        "parent-slug": "/bureaux-et-magasins-sur-mesure"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/bureaux-et-magasins-sur-mesure/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Cjbmdz8x.mjs.map

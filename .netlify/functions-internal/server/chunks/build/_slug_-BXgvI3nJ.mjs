...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const story = ([__temp, __restore] = withAsyncContext(() => useAsyncStoryblok("salles-de-bain", {
      version: "published"
    ...
    const breadcrumbs = [
      ...
      {
        name: "Salles de bain",
        url: "/salle-de-bain-sur-mesure-savoie"
      },
      {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="furniture-page" data-v-e95d0be2><div class="furniture-page__wrapper" data-v-e95d0be2><div class="furniture-page__wrapper__txt" data-v-e95d0be2><h1 class="furniture-page__wrapper__txt__title" data-v-e95d0be2>${ssrInterpolate(unref(furniture).title)}</h1><h2 class="furniture-page__wrapper__txt__subtitle" data-v-e95d0be2>${ssrInterpolate(unref(furniture).subtitle)}</h2><div class="furniture-page__wrapper__txt__richtext" data-v-e95d0be2>${(_a = ("renderRichText" in _ctx ? _ctx.renderRichText : unref(Ce))(unref(furniture).description)) != null ? _a : ""}</div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/salle-de-bain-sur-mesure-savoie/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e95d0be2"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-BXgvI3nJ.mjs.map

...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead$1({
      title: "Salle de bain sur mesure | J\xE9r\xF4me Provost Eb\xE9nisterie",
      meta: [
        {
          name: "description",
          content: "Cr\xE9ation de salles de bain sur mesure \xE0 Chamb\xE9ry en Savoie. D\xE9couvrez tous nos salles de bain sur mesure."
        }
      ]
    });
    const breadcrumbs = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FurnitureShowcase, {
        story: unref(story),
        "parent-slug": "/salle-de-bain-sur-mesure-savoie"
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/salle-de-bain-sur-mesure-savoie/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BW64LVOq.mjs.map

...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const story = ([__temp, __restore] = withAsyncContext(() => useAsyncStoryblok("entree", {
      version: "published"
    ...
    const breadcrumbs = [
      ...
      {
        name: "Meubles d'entr\xE9e",
        url: "/meubles-entree-sur-mesure"
      },
      {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="furniture-page" data-v-0f8eeb12><div class="furniture-page__wrapper" data-v-0f8eeb12><div class="furniture-page__wrapper__txt" data-v-0f8eeb12><h1 class="furniture-page__wrapper__txt__title" data-v-0f8eeb12>${ssrInterpolate(unref(furniture).title)}</h1><h2 class="furniture-page__wrapper__txt__subtitle" data-v-0f8eeb12>${ssrInterpolate(unref(furniture).subtitle)}</h2><div class="furniture-page__wrapper__txt__richtext" data-v-0f8eeb12>${(_a = ("renderRichText" in _ctx ? _ctx.renderRichText : unref(Ce))(unref(furniture).description)) != null ? _a : ""}</div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/meubles-entree-sur-mesure/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0f8eeb12"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-GG8fGLK0.mjs.map
